...
// File: contracts/cp/GenesisSmartContract.sol
...
contract Genesis is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://example.com/<METADATA FOLDER>";
    }
    ...
    function record(uint256 tokenId) public payable {
